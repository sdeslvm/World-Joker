...
class WorldJokerWebCoordinator: NSObject, WKNavigationDelegate {
    private let callback: (WorldJokerWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (WorldJokerWebStatus) -> Void) {
