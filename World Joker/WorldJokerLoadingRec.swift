...
protocol WorldJokerWebLoadable: AnyObject {
    var state: WorldJokerWebStatus { get set }
    func setConnectivity(_ available: Bool)
}

/// Протокол для мониторинга прогресса загрузки
protocol WorldJokerProgressMonitoring {
...
final class WorldJokerWebLoader: NSObject, ObservableObject, WorldJokerWebLoadable, WorldJokerProgressMonitoring {
    // MARK: - Свойства
    
    @Published var state: WorldJokerWebStatus = .standby
...
extension WorldJokerWebLoader: WKNavigationDelegate {
